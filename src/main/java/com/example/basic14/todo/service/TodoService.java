...
public class TodoService {
    ...
    public TodoResponseDto findById(Long todoId) {
        Todo todo = todoRepository.findById(todoId).orElseThrow(
                ()-> new IllegalStateException("그런 Todo 없음")
        );
